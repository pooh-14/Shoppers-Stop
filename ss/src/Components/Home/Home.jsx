...
const Home = () => {
  return (
    <div id='image'>
      ...
      <img className='sale' src="https://sslimages.shoppersstop.com/sys-master/root/h52/h3a/30444789825566/Trending-Brand-Deals%21_Strip-web_eoss-2023.jpg" />
      <img className='banner' src="https://sslimages.shoppersstop.com/sys-master/root/h38/h95/30440578711582/kraus--carousel-Web_mega%20sale-2023.jpg" />
      <img className='sale' src="https://sslimages.shoppersstop.com/sys-master/root/h7c/h3b/30162824167454/Featured-Brands_Strip-web.jpg"/>
      <img className='banner' src="https://sslimages.shoppersstop.com/sys-master/root/h88/h1a/30352171106334/myshka-static--web_7ntey563.jpg"/>
